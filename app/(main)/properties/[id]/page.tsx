...
import { ContactAgentButton } from "@/components/property/contact-agent-button";
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
                ...
                <div>
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    {statusLabel && (
                      <Badge
                        variant={
                          property.status === "sold" ? "destructive" : "ghost"
                        }
                      >
                        {statusLabel}
                      </Badge>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              ...
              <StatBadge
                icon={Square}
                value={String(property.squareFeet || 0)}
                label="Sq Ft"
                color="primary"
              />
              {property.yearBuilt && (
              ...
              <Card className="shadow-warm overflow-hidden">
                ...
                <CardContent className="p-0">
                  <div className="pl-6 pr-6 text-lg">
                    It would be nice to have a map here showing the property's
                    location, but we're getting cheap. Just google this
                    coordinates(and pretend you're a map): <br></br>
                    <div className="flex">
                      <MapPinHouse className="mt-3  mr-2 md:mr-6  md:ml-12" />
                      <span className=" mt-2 font-weight-medium bg-accent/50 px-2 py-1 rounded">
